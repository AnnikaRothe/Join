...
function showCheckboxes(index) {
  ...
  document.getElementById(`selectBox${index}`).style.borderBottomLeftRadius =
    "0";
  document.getElementById(`selectBox${index}`).style.borderBottomRightRadius =
    "0";
  if (!expanded[index - 1]) {
    closeOtherMenus(index - 1);
...
/**
 * This function closes the dropwdown menus
 *
 * @param {*} index  is the number in the array
 */
function closeOtherMenus(excludeIndex) {
  for (let i = 0; i < expanded.length; i++) {
    if (i !== excludeIndex && expanded[i]) {
      showCheckboxes(i + 1);
    }
  }
}
...
/**
 * This function adds an eventListener an tests, if there`s any open checkbox
 *
 * @param {*} index  is the number in the array
 */
...
function addRandomBackgroundColorToNewCategory() {
  randomBgColor = [];
  random = Math.floor(
    Math.random() * contentArray["settings"]["categoryBgColor"].length
  );
...
function addPrio(priority) {
  ...
  if (addPriority == "urgent") {
    document.getElementById(`changePrioColor${priority}`).style.background =
      "#FF3D00";
    document.getElementById(`changePrioColor${priority}`).style.color = "white";
    document.querySelector(`#changePrioColor${priority} img`).src =
      "./assets/img/task-prio-urgent-white.png";
  }
  if (addPriority == "medium") {
    ...
    document.getElementById(`changePrioColor${priority}`).style.color = "white";
    document.querySelector(`#changePrioColor${priority} img`).src =
      "./assets/img/add-task-prio-medium-white.png";
  }
  if (addPriority == "low") {
    document.getElementById(`changePrioColor${priority}`).style.background =
      "#7AE229";
    document.getElementById(`changePrioColor${priority}`).style.color = "white";
    document.querySelector(`#changePrioColor${priority} img`).src =
      "./assets/img/add-task-prio-low-white.png";
  }
}
...
function resetPrioColor() {
  ...
  document.querySelector(`#changePrioColorurgent img`).src =
    "./assets/img/task-prio-urgent.png";
  ...
  document.querySelector(`#changePrioColormedium img`).src =
    "./assets/img/task-prio-medium.png";
  ...
  document.querySelector(`#changePrioColorlow img`).src =
    "./assets/img/task-prio-low.png";
}
